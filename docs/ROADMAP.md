...
## Phase 4 — Business
- ◐ Soulfire economy, shop, rewarded-ad boosts, Remove Ads, starter pack, skins (engine done; UI in progress)
- ◐ `services/monetization.ts` (fake store done; RevenueCat/AdMob + consent todo)
- ◐ Daily login (done), achievements, notifications
